...
- Если нужно, сделай ещё один семантический поиск с более уточнённым запросом, фокусируясь на конкретных аспектах
...
Этап 3:
  ...
  - Если нужно: ещё один семантический поиск "данные обучения GPT-4 параметры" для углубления
```
...
- **ОБЯЗАТЕЛЬНО используй многоэтапный поиск (3 этапа выше)!**
- Проанализируй текущую структуру базы знаний
- Проанализируй контент текущих файлов базы знаний
- Этап 1: Файловый поиск по ключевым словам
- Этап 2: Векторный семантический поиск
- Этап 3: Уточняющий поиск по найденным файлам
...
- **ОБЯЗАТЕЛЬНО используй многоэтапный поиск (файловый → векторный → уточняющий)!**
