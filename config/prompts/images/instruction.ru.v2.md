...
**2. Обработай КАЖДОЕ изображение ПО ОЧЕРЕДИ:**
   ...
   Для изображения #1:
   - Имя файла: `images/img_1234567890_abc12345.jpg`
   - Метаданные: `images/img_1234567890_abc12345.md`
...
- Из `topics/`: `![описание](../images/img_123.jpg)`
- Из `topics/subfolder/`: `![описание](../../images/img_123.jpg)`
- Из корня KB: `![описание](images/img_123.jpg)`
...
```markdown
![Краткое описание для alt-text](../images/img_123.jpg)
