...
**Что делать:**
1. Для каждого изображения (например, `img_123.jpg`) существует файл описания `img_123.md` в той же папке `images/`
...
3. **ЗАПРЕЩЕНО дублировать изображения!**
   ...
   **ПРАВИЛЬНО:**
   ```markdown
   ![Complete description covering all aspects](../images/img_123.jpg)
...
4. **Читай метаданные изображений:**
   ...
   - Замени расширение: `img_123.jpg` → `img_123.md`
   - Путь такой же как к изображению: если изображение в `images/img_123.jpg`, то описание в `images/img_123.md`
   - Примеры путей от topics/:
     - Изображение: `../images/img_123.jpg`
     - Описание: `../images/img_123.md`
