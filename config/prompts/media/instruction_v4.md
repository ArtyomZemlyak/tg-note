...
- Чекбоксы в `Медиафайлы:` обязательны: закрывай `[ ]` только после чтения `.md/.json` (docling OCR) и вставки самого медиа с описанием в БЗ.
...
2. **Обработай медиафайлы итеративно.**
   ...
   - Шаги:
     ...
     5. Закрой чекбокс у конкретного файла только после вставки изображения и учета информации из метаданных.
