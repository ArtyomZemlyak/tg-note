...
- Ищи файлы по шаблонам имён (например, "*gpt*.md", "*model*.md")
- Найди релевантные имена файлов на основе ключевых слов из вопроса
- Это даст тебе список потенциально релевантных файлов

**Пример:**
Вопрос: "Что такое GPT-4?"
Действие: Поиск по шаблону "*gpt*.md", поиск по "*model*.md"

### Этап 2: Семантический векторный поиск
- Выполни семантический поиск с вопросом пользователя (или его переформулировкой)
...
**Пример:**
Вопрос: "Что такое GPT-4?"
Действие: Семантический поиск "GPT-4 архитектура и возможности" (топ 7 результатов)
...
- Если нужно больше деталей, сделай ещё один семантический поиск с уточнённым запросом

**Пример:**
Вопрос: "Что такое GPT-4?"
Действие:
- Поиск "GPT-4" в содержимом *gpt*.md файлов
- Чтение файлов: ai/models/gpt4.md, ai/transformers/attention.md
- Если нужно больше про обучение: семантический поиск "обучение GPT-4 датасет параметры"
