...
class AgentRegistry:
    ...
    def create(self, name: str, config: Optional[Dict] = None) -> BaseAgent:
        ...
        raise ValueError(f"Unknown agent type: {name}. " f"Available types: {available}")
...
def register_agent(
    name: str, agent_class: Optional[Type[BaseAgent]] = None, factory: Optional[Callable] = None
) -> None:
    """
