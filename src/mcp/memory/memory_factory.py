        ...
        **kwargs,
        ...
        try:
            ...
            if storage_type == "json":
                ...
                logger.info(
                    f"✅ VectorBasedMemoryStorage created with model '{model_name}' at {data_dir}"
                )
                ...
                logger.info(
                    f"✅ MemAgentStorage created with model '{model_name or 'default'}', backend={backend} at {data_dir}"
                )
