...
class KnowledgeBaseManager:
    ...
    def create_article(
        self, content: str, title: str, category: str = "general", metadata: Optional[Dict] = None
    ) -> str:
        """
    ...
    def _create_frontmatter(self, title: str, category: str, metadata: Optional[Dict]) -> str:
        """
