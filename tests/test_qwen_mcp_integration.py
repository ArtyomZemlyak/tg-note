...
class TestMemAgentMCPServer:
    ...
    async def test_call_store_memory(self, server):
        ...
        result = await server.handle_call_tool(
            "store_memory",
            {"content": "Test memory", "category": "test"}
        )
    ...
    async def test_call_retrieve_memory(self, server):
        ...
        await server.handle_call_tool(
            "store_memory",
            {"content": "Test memory 1", "category": "test"}
        )
        await server.handle_call_tool(
            "store_memory",
            {"content": "Test memory 2", "category": "test"}
        )
    ...
    async def test_call_list_categories(self, server):
        ...
        await server.handle_call_tool(
            "store_memory",
            {"content": "M1", "category": "cat1"}
        )
        await server.handle_call_tool(
            "store_memory",
            {"content": "M2", "category": "cat2"}
        )
